...
baselineRate = 0.1;          % Baseline firing rate (spikes/time bin)
transientAmplitude = 1;   % Peak additional firing rate due to transient
...
% Parameters
response_offset = 9; % how many frames after the first?
...
% Export to eps
fig_path = (string(smout('figures/Figure6-IFI')) + "IFI_schem_BU_slope.eps");
fprintf("\nSaving %s\n", fig_path)
...
% Export to eps
fig_path = (string(smout('figures/Figure6-IFI')) + "IFI_schem_BU_src.eps");
fprintf("\nSaving %s\n", fig_path)
...
% Export to eps
fig_path = (string(smout('figures/Figure6-IFI')) + "IFI_schem_BU_tgt.eps");
fprintf("\nSaving %s\n", fig_path)
